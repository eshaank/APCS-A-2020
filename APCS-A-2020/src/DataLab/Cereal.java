...
public class Cereal {
	...
	Cereal(String nm, char tp, int cal, int ptn, int f, int sod, int fib, int carb, int sug, int ptsm, int vtm, int shf,
			double wght, double cps, double rtng) {
	...
	public static void main(String[] args) {
		Cereal num1 = new Cereal("Frosted Flakes", 'C', 110, 1, 0, 200, 1, 14, 11, 25, 25, 1, 1, 0.75, 31.435973);
